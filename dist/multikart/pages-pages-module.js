...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/change-password/change-password.component.html":
/*!************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/change-password/change-password.component.html ***!
  \************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "\n<!-- breadcrumb End -->\n<!-- section start -->\n<section class=\"pwd-page\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-lg-12\">\n                <h2>Enter your otp Code send in you email</h2>\n                <form class=\"theme-form\">\n                    <div class=\"form-row\">\n\t\t\t\t\t\t<div style=\"display:none;\" class=\"pass_succ col-md-12\">\n\t\t\t\t\t\t\t<span>Successfully</span>\n                        </div>\n\t\t\t\t\t\t<div class=\"col-md-12\">\n                            <input type=\"text\" class=\"form-control\" id=\"old_pass\" placeholder=\"Enter old password\" required=\"\">\n                        </div>\n                        <div class=\"col-md-12\">\n                            <input type=\"text\" class=\"form-control\" id=\"otp_code\" placeholder=\"OTP code\" required=\"\">\n                        </div>\n                        <button (click)=\"changePassword()\" class=\"btn btn-solid\">Submit</button>\n                    </div>\n                </form>\n            </div>\n        </div>\n    </div>\n</section>\n\n<!--Section ends-->"
...
module.exports = "<!-- breadcrumb start -->\n<div class=\"breadcrumb-section\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-sm-6\">\n                <div class=\"page-title\">\n                    <h2>forget password</h2>\n                </div>\n            </div>\n            <div class=\"col-sm-6\">\n                <nav aria-label=\"breadcrumb\" class=\"theme-breadcrumb\">\n                    <ol class=\"breadcrumb\">\n                        <li class=\"breadcrumb-item\"><a [routerLink]=\"'/home/one'\">Home</a></li>\n                        <li class=\"breadcrumb-item\"><a [routerLink]=\"'/pages/login'\">login</a></li>\n                        <li class=\"breadcrumb-item active\" aria-current=\"page\">forget password</li>\n                    </ol>\n                </nav>\n            </div>\n        </div>\n    </div>\n</div>\n<!-- breadcrumb End -->\n<!-- section start -->\n<section class=\"pwd-page\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-lg-6 offset-lg-3\">\n                <h2>Forget Your Password</h2>\n                <form class=\"theme-form\">\n\t\t\t\t\t\n\t\t\t\t\t<div class=\"form-row\">\n\t\t\t\t\t\t<div style=\"display:none;\" class=\"pass_succ col-md-12\">\n\t\t\t\t\t\t\t<span>Successfully</span>\n                        </div>\n\t\t\t\t\t\t<div style=\"display:none; color:red; text-align:center;\" class=\"otp_fail col-md-12\">\n\t\t\t\t\t\t\t<span>Successfully</span>\n                        </div>\n                    </div>\n\t\t\t\t\t\n\t\t\t\t\t<!-----------Forget Email------------->\n                    <div class=\"form-row email_forgot\">\n\t\t\t\t\t\t\n                        <div class=\"col-md-12\">\n                            <input type=\"text\" class=\"form-control\" id=\"email\" placeholder=\"Enter Your Email\" required=\"\">\n                        </div>\n                        <button (click)=\"getForgotemail()\" class=\"btn btn-solid\">Submit</button>\n                    </div>\n\t\t\t\t\t<!-----------otp code------------->\n\t\t\t\t\t<div style=\"display:none;\" class=\"form-row otp_code\">\n\t\t\t\t\t\t<div style=\"display:none;\" class=\"pass_succ col-md-12\">\n\t\t\t\t\t\t\t<span>Successfully</span>\n                        </div>\n                        <div class=\"col-md-12\">\n                            <input type=\"number\" class=\"form-control\" id=\"your_otp_code\" placeholder=\"Enter your OTP\" required=\"\">\n\t\t\t\t\t\t\t<input type=\"password\" class=\"form-control\" id=\"new_pass\" placeholder=\"New Password\" required=\"\">\n                        </div>\n                        <button (click)=\"OTPSend()\" class=\"btn btn-solid\">Submit</button>\n                    </div>\n\t\t\t\t\t\n\t\t\t\t\t\n                </form>\n            </div>\n        </div>\n    </div>\n</section>\n\n\n<!--Section ends-->"
...
module.exports = "<!-- breadcrumb start -->\n<div class=\"breadcrumb-section\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-sm-6\">\n                <div class=\"page-title\">\n                    <h2>customer's login</h2>\n                </div>\n            </div>\n            <div class=\"col-sm-6\">\n                <nav aria-label=\"breadcrumb\" class=\"theme-breadcrumb\">\n                    <ol class=\"breadcrumb\">\n                        <li class=\"breadcrumb-item\"><a [routerLink]=\"'/home/one'\">Home</a></li>\n                        <li class=\"breadcrumb-item active\" >login</li>\n                    </ol>\n                </nav>\n            </div>\n        </div>\n    </div>\n</div>\n<!-- breadcrumb End -->\n<!-- section start -->\n<section class=\"login-page section-b-space\">\n    <div class=\"container\">\n        <div class=\"row\">\n\t\t\t\n\t\t<div class=\"col-lg-12\">\n\t\t\t<div class=\"theme-card \">\n\t\t\t\t<h3>Login</h3>\n\t\t\t\t<div class=\"infinite-scrolling\" style=\"display:none;\">\n\t\t\t\t\t<img src=\"assets/images/loader.gif\">\n\t\t\t\t</div>\n\t\t\t\t<form class=\"theme-form\">\n\t\t\t\t\t<div class=\"form-group error_msg\">\n\t\t\t\t\t\t<span style='display:none;' class='email_invalid'>Not a valid email address</span>\n\t\t\t\t\t\t<span style='display:none;' class='password_failed'>Please check if password is correct</span>\n\t\t\t\t\t\t<span style='display:none;' class='invalid_request'>Request is not valid</span>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"form-group success_msg\">\n\t\t\t\t\t\t<span style='display:none;' class='email_valid'>Correct Email address please enter password</span>\n\t\t\t\t\t\t<span style='display:none;' class='password_valid'>Password is correct</span>\n\t\t\t\t\t\t\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"form-group login_msg\">\n\t\t\t\t\t\t<span style='display:none;' class='login_success'>Login Success</span>\n\t\t\t\t\t</div>\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<input type=\"text\" class=\"form-control text_field\" id=\"email\" placeholder=\"Email\" required=\"\">\n\t\t\t\t\t</div>\n\t\t\t\t\t<div style=\"display:none;\" class=\"form-group second_password\">\n\t\t\t\t\t\t<input type=\"password\" class=\"form-control text_field\" id=\"password\" placeholder=\"Enter your password\" required=\"\">\n\t\t\t\t\t</div>\n\t\t\t\t\t<div style=\"display:none;\" class=\"form-group third_accountid\">\n\t\t\t\t\t\t<input type=\"text\" class=\"form-control text_field\" id=\"account_id\" placeholder=\"Enter your AccountId\" required=\"\">\n\t\t\t\t\t</div>\n\t\t\t\t\t<button class=\"btn btn-solid conemail\" (click)=\"confirmEmailA()\">Confirm Email</button>\n\t\t\t\t\t<button style=\"display:none;\" (click)=\"getLoginFormValues()\" class=\"btn btn-solid loginbtn\">Login</button>\n\t\t\t\t\t<div class=\"form-group\">\n\t\t\t\t\t\t<a style=\"margin-top:10px;\" href='{{user_url}}/pages/forgetpassword' class=\"forgot_pass\"><strong>Forgot Password?</strong></a>\n\t\t\t\t\t</div>\n\t\t\t\t</form>\n                </div>\n            </div>\n\t\t\t\n        </div>\n    </div>\n</section>\n\n<style>\n.error_msg{\n\tcolor:red;\n\ttext-align:center;\n}\n.success_msg{\n\tcolor:green;\n\ttext-align:center;\n}\n.login_msg{\n\tcolor:green;\n\ttext-align:center;\n}\n</style>\n<!--Section ends-->"
...
module.exports = "<!-- thank-you section start -->\n<section class=\"section-b-space light-layout\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-md-12\">\n                <div class=\"success-text\">\n                    <i class=\"fa fa-check-circle\" aria-hidden=\"true\"></i>\n                    <h2>thank you</h2>\n                    <p>{{saveorder.message}}</p>\n                    <p>Order ID: {{saveorder.orderid}}</p>\n                </div>\n            </div>\n        </div>\n    </div>\n</section>\n<!-- Section ends -->\n<!-- order-detail section start -->\n<section class=\"section-b-space\">\n    <div class=\"container\">\n        <div class=\"row\">\n            <div class=\"col-lg-6\">\n                <div class=\"product-order\">\n                    <h3>your order details</h3>\n\n                   <div class=\"row product-order-detail\" *ngFor=\"let product_details of saveorder.cartdetails.products\">\n                        <div class=\"col-3\">\n                            <img src=\"assets/images/pro3/1.jpg\" alt=\"\" class=\"img-fluid\">\n                        </div>\n                        <div class=\"col-3 order_detail\">\n                            <div>\n                                <h4>product name</h4>\n                                <h5>{{product_details.pro_title}}</h5>\n                            </div>\n                        </div>\n                        <div class=\"col-3 order_detail\" >\n                            <div >\n                                <h4>Quantity</h4>\n                                <h5 *ngFor=\"let sub_details of product_details.sub\">{{sub_details.n_size}}[{{sub_details.qty}}]</h5>\n                            </div>\n                        </div>\n                        <div class=\"col-3 order_detail\">\n                            <div >\n                                <h4>price</h4>\n                               \n\t\t\t\t\t\t\t\t<h5 >\n\t\t\t\t\t\t\t\t<p >\n\t\t\t\t\t\t\t\t${{product_details.price | number : fractionSize}}\n\t\t\t\t\t\t\t\t</p>  \n\t\t\t\t\t\t\t\t</h5>\n\n\t\t\t\t\t\t\t\t\n                            </div>\n                        </div>\n                    </div>\n                   \n                    <div class=\"final-total\">\n                        <h3>total <span>${{getTotalCartPrice | number : fractionSize}}</span></h3>   \n                    </div>\n                </div>\n            </div>\n            <div class=\"col-lg-6\">\n                <div class=\"row order-success-sec\">\n                    <div class=\"col-sm-6\">\n                        <h4>summery</h4>\n                        <ul class=\"order-detail\">\n                            <li>order ID: {{saveorder.orderid}}</li>\n                            <li>Order Date: {{saveorder.orderdate}}</li>\n                            <li>Order Total: ${{getTotalCartPrice}}</li>\n                        </ul>\n                    </div>\n                    <div class=\"col-sm-6\">\n                        <h4>shipping address</h4>\n                        <ul class=\"order-detail\">\n                            <li>{{saveorder.shippingaddres.address_1}}</li>\n                            <li>{{saveorder.shippingaddres.address_2}}, {{saveorder.shippingaddres.city}}</li>\n                            <li>{{saveorder.shippingaddres.state}}, {{saveorder.shippingaddres.country}}, {{saveorder.shippingaddres.postal_code}}</li>\n                            <li>Contact No. {{saveorder.shippingaddres.phone}}</li>\n                        </ul>\n                    </div>\n\n                </div>\n            </div>\n\n        </div>\n    </div>\n</section>\n<!-- Section ends -->"
...
/***/ "./node_modules/raw-loader/index.js!./src/app/pages/save-order-details/save-order-details.component.html":
/*!******************************************************************************************************!*\
  !*** ./node_modules/raw-loader!./src/app/pages/save-order-details/save-order-details.component.html ***!
  \******************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports) {

module.exports = "\t<section class=\"section-b-space light-layout\">\n\t<div class=\"container\">\n\t\t<div class=\"row\">\n\t\t\t<div class=\"col-md-12\">\n\t\t\t\t<div class=\"success-text\">\n\t\t\t\t\t<i aria-hidden=\"true\" class=\"fa fa-check-circle\"></i>\n\t\t\t\t\t<h2>Thank you</h2>\n\t\t\t\t\t<p>Your Order Has Been Saved!!</p>\n\t\t\t\t\t<p>Order ID: {{testhtml.ref_id}}</p>\n\t\t\t\t</div>\n\t\t\t</div>\n\t\t</div>\n\t</div>\n</section>"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvYWJvdXQtdXMvYWJvdXQtdXMuY29tcG9uZW50LnNjc3MifQ== */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvY2FydC9jYXJ0LmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvY2hhbmdlLXBhc3N3b3JkL2NoYW5nZS1wYXNzd29yZC5jb21wb25lbnQuc2NzcyJ9 */"
...
var ChangePasswordComponent = /** @class */ (function () {
    function ChangePasswordComponent(httpClient, loginService) {
    ...
    ChangePasswordComponent.prototype.OTPSend = function () {
    };
    ChangePasswordComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-change-password',
            template: __webpack_require__(/*! raw-loader!./change-password.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/change-password/change-password.component.html"),
            styles: [__webpack_require__(/*! ./change-password.component.scss */ "./src/app/pages/change-password/change-password.component.scss")]
        }),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _shared_services_login_service__WEBPACK_IMPORTED_MODULE_1__["LoginService"]])
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvY2hlY2tvdXQvY2hlY2tvdXQuY29tcG9uZW50LnNjc3MifQ== */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvY29sbGVjdGlvbi9jb2xsZWN0aW9uLmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvY29tcGFyZS9jb21wYXJlLmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvY29udGFjdC9jb250YWN0LmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvZGFzaGJvYXJkL2Rhc2hib2FyZC5jb21wb25lbnQuc2NzcyJ9 */"
...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.checkLogout = function () {
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvZXJyb3ItcGFnZS9lcnJvci1wYWdlLmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvZmFxL2ZhcS5jb21wb25lbnQuc2NzcyJ9 */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvZm9yZ2V0LXBhc3N3b3JkL2ZvcmdldC1wYXNzd29yZC5jb21wb25lbnQuc2NzcyJ9 */"
...
var ForgetPasswordComponent = /** @class */ (function () {
    ...
    ForgetPasswordComponent.prototype.getForgotemail = function () {
        event.preventDefault();
        var email = (document.getElementById("email").value);
        this.loginService.forgetPassword(email);
        console.log(email);
    };
    ForgetPasswordComponent.prototype.OTPSend = function () {
        event.preventDefault();
        var otp_code = (document.getElementById("your_otp_code").value);
        var email = (document.getElementById("email").value);
    ...
    ForgetPasswordComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_shared_services_login_service__WEBPACK_IMPORTED_MODULE_1__["LoginService"]])
...
/* harmony import */ var _variables__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../variables */ "./src/app/variables.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(route, router, loginService) {
        ...
        this.router = router;
        this.loginService = loginService;
        this.user_url = _variables__WEBPACK_IMPORTED_MODULE_3__["url_text"];
    }
    ...
    LoginComponent.prototype.getLoginFormValues = function () {
        event.preventDefault();
        var email = (document.getElementById("email").value);
    ...
    LoginComponent.prototype.confirmEmailA = function () {
        event.preventDefault();
        var email = (document.getElementById("email").value);
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["ActivatedRoute"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], _shared_services_login_service__WEBPACK_IMPORTED_MODULE_1__["LoginService"]])
    ], LoginComponent);
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvbG9va2Jvb2svbG9va2Jvb2suY29tcG9uZW50LnNjc3MifQ== */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvb3JkZXItc3VjY2Vzcy9vcmRlci1zdWNjZXNzLmNvbXBvbmVudC5zY3NzIn0= */"
...
var OrderSuccessComponent = /** @class */ (function () {
    ...
    function OrderSuccessComponent() {
        this.saveorder = JSON.parse(localStorage.getItem("saveorderdata"));
        this.getTotalCartPrice = 0;
        this.showMsg = false;
        this.showerrMsg = false;
    }
    OrderSuccessComponent.prototype.ngOnInit = function () {
        var total = parseFloat(localStorage.getItem("totalPriceCustom"));
...
/* harmony import */ var _save_order_details_save_order_details_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./save-order-details/save-order-details.component */ "./src/app/pages/save-order-details/save-order-details.component.ts");
/* harmony import */ var _error_page_error_page_component__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./error-page/error-page.component */ "./src/app/pages/error-page/error-page.component.ts");
/* harmony import */ var _lookbook_lookbook_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./lookbook/lookbook.component */ "./src/app/pages/lookbook/lookbook.component.ts");
/* harmony import */ var _login_login_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./login/login.component */ "./src/app/pages/login/login.component.ts");
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./register/register.component */ "./src/app/pages/register/register.component.ts");
...
/* harmony import */ var _wishlist_wishlist_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./wishlist/wishlist.component */ "./src/app/pages/wishlist/wishlist.component.ts");
/* harmony import */ var _cart_cart_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./cart/cart.component */ "./src/app/pages/cart/cart.component.ts");
/* harmony import */ var _collection_collection_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./collection/collection.component */ "./src/app/pages/collection/collection.component.ts");
/* harmony import */ var _forget_password_forget_password_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./forget-password/forget-password.component */ "./src/app/pages/forget-password/forget-password.component.ts");
/* harmony import */ var _contact_contact_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./contact/contact.component */ "./src/app/pages/contact/contact.component.ts");
/* harmony import */ var _checkout_checkout_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./checkout/checkout.component */ "./src/app/pages/checkout/checkout.component.ts");
/* harmony import */ var _compare_compare_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./compare/compare.component */ "./src/app/pages/compare/compare.component.ts");
/* harmony import */ var _order_success_order_success_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./order-success/order-success.component */ "./src/app/pages/order-success/order-success.component.ts");
...
/* harmony import */ var _typography_typography_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./typography/typography.component */ "./src/app/pages/typography/typography.component.ts");
/* harmony import */ var _faq_faq_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./faq/faq.component */ "./src/app/pages/faq/faq.component.ts");
/* harmony import */ var _portfolio_grid_two_col_grid_two_col_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./portfolio/grid-two-col/grid-two-col.component */ "./src/app/pages/portfolio/grid-two-col/grid-two-col.component.ts");
/* harmony import */ var _portfolio_grid_three_col_grid_three_col_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./portfolio/grid-three-col/grid-three-col.component */ "./src/app/pages/portfolio/grid-three-col/grid-three-col.component.ts");
/* harmony import */ var _portfolio_grid_four_col_grid_four_col_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./portfolio/grid-four-col/grid-four-col.component */ "./src/app/pages/portfolio/grid-four-col/grid-four-col.component.ts");
/* harmony import */ var _portfolio_masonary_two_grid_masonary_two_grid_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./portfolio/masonary-two-grid/masonary-two-grid.component */ "./src/app/pages/portfolio/masonary-two-grid/masonary-two-grid.component.ts");
/* harmony import */ var _portfolio_masonary_three_grid_masonary_three_grid_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./portfolio/masonary-three-grid/masonary-three-grid.component */ "./src/app/pages/portfolio/masonary-three-grid/masonary-three-grid.component.ts");
/* harmony import */ var _portfolio_masonary_four_grid_masonary_four_grid_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./portfolio/masonary-four-grid/masonary-four-grid.component */ "./src/app/pages/portfolio/masonary-four-grid/masonary-four-grid.component.ts");
/* harmony import */ var _portfolio_masonary_fullwidth_masonary_fullwidth_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./portfolio/masonary-fullwidth/masonary-fullwidth.component */ "./src/app/pages/portfolio/masonary-fullwidth/masonary-fullwidth.component.ts");
/* harmony import */ var _change_password_change_password_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./change-password/change-password.component */ "./src/app/pages/change-password/change-password.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var routes = [
    {
        ...
        children: [
            ...
            {
                path: 'save-order-details',
                component: _save_order_details_save_order_details_component__WEBPACK_IMPORTED_MODULE_3__["SaveOrderDetailsComponent"]
            },
            {
                path: '404',
            ...
            {
                path: 'lookbook',
                component: _lookbook_lookbook_component__WEBPACK_IMPORTED_MODULE_5__["LookbookComponent"]
            },
            {
                path: 'login',
            ...
            {
                path: 'forgetpassword',
                component: _forget_password_forget_password_component__WEBPACK_IMPORTED_MODULE_12__["ForgetPasswordComponent"]
            },
            {
                path: 'changepassword',
                component: _change_password_change_password_component__WEBPACK_IMPORTED_MODULE_27__["ChangePasswordComponent"]
            },
            {
                path: 'contact',
            ...
            {
                path: 'compare',
                component: _compare_compare_component__WEBPACK_IMPORTED_MODULE_15__["CompareComponent"]
            },
            {
                path: 'order-success',
            ...
            {
                path: 'typography',
                component: _typography_typography_component__WEBPACK_IMPORTED_MODULE_18__["TypographyComponent"]
            },
            {
                path: 'faq',
                component: _faq_faq_component__WEBPACK_IMPORTED_MODULE_19__["FaqComponent"]
            },
            {
                path: 'grid/two/column',
                component: _portfolio_grid_two_col_grid_two_col_component__WEBPACK_IMPORTED_MODULE_20__["GridTwoColComponent"]
            },
            {
                path: 'grid/three/column',
                component: _portfolio_grid_three_col_grid_three_col_component__WEBPACK_IMPORTED_MODULE_21__["GridThreeColComponent"]
            },
            {
                path: 'grid/four/column',
                component: _portfolio_grid_four_col_grid_four_col_component__WEBPACK_IMPORTED_MODULE_22__["GridFourColComponent"]
            },
            {
                path: 'grid/two/masonary',
                component: _portfolio_masonary_two_grid_masonary_two_grid_component__WEBPACK_IMPORTED_MODULE_23__["MasonaryTwoGridComponent"]
            },
            {
                path: 'grid/three/masonary',
                component: _portfolio_masonary_three_grid_masonary_three_grid_component__WEBPACK_IMPORTED_MODULE_24__["MasonaryThreeGridComponent"]
            },
            {
                path: 'grid/four/masonary',
                component: _portfolio_masonary_four_grid_masonary_four_grid_component__WEBPACK_IMPORTED_MODULE_25__["MasonaryFourGridComponent"]
            },
            {
                path: 'fullwidth/masonary',
                component: _portfolio_masonary_fullwidth_masonary_fullwidth_component__WEBPACK_IMPORTED_MODULE_26__["MasonaryFullwidthComponent"]
            }
        ]
    }
];
...
/* harmony import */ var _save_order_details_save_order_details_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./save-order-details/save-order-details.component */ "./src/app/pages/save-order-details/save-order-details.component.ts");
...
/* harmony import */ var _lookbook_lookbook_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./lookbook/lookbook.component */ "./src/app/pages/lookbook/lookbook.component.ts");
...
/* harmony import */ var _register_register_component__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./register/register.component */ "./src/app/pages/register/register.component.ts");
...
/* harmony import */ var _wishlist_wishlist_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./wishlist/wishlist.component */ "./src/app/pages/wishlist/wishlist.component.ts");
/* harmony import */ var _cart_cart_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./cart/cart.component */ "./src/app/pages/cart/cart.component.ts");
/* harmony import */ var _collection_collection_component__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./collection/collection.component */ "./src/app/pages/collection/collection.component.ts");
/* harmony import */ var _forget_password_forget_password_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./forget-password/forget-password.component */ "./src/app/pages/forget-password/forget-password.component.ts");
/* harmony import */ var _contact_contact_component__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./contact/contact.component */ "./src/app/pages/contact/contact.component.ts");
/* harmony import */ var _checkout_checkout_component__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./checkout/checkout.component */ "./src/app/pages/checkout/checkout.component.ts");
/* harmony import */ var _compare_compare_component__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./compare/compare.component */ "./src/app/pages/compare/compare.component.ts");
/* harmony import */ var _order_success_order_success_component__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./order-success/order-success.component */ "./src/app/pages/order-success/order-success.component.ts");
/* harmony import */ var _dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! ./dashboard/dashboard.component */ "./src/app/pages/dashboard/dashboard.component.ts");
/* harmony import */ var _faq_faq_component__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! ./faq/faq.component */ "./src/app/pages/faq/faq.component.ts");
/* harmony import */ var _typography_typography_component__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./typography/typography.component */ "./src/app/pages/typography/typography.component.ts");
/* harmony import */ var _portfolio_grid_two_col_grid_two_col_component__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ./portfolio/grid-two-col/grid-two-col.component */ "./src/app/pages/portfolio/grid-two-col/grid-two-col.component.ts");
/* harmony import */ var _portfolio_grid_three_col_grid_three_col_component__WEBPACK_IMPORTED_MODULE_24__ = __webpack_require__(/*! ./portfolio/grid-three-col/grid-three-col.component */ "./src/app/pages/portfolio/grid-three-col/grid-three-col.component.ts");
/* harmony import */ var _portfolio_grid_four_col_grid_four_col_component__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./portfolio/grid-four-col/grid-four-col.component */ "./src/app/pages/portfolio/grid-four-col/grid-four-col.component.ts");
/* harmony import */ var _portfolio_masonary_two_grid_masonary_two_grid_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./portfolio/masonary-two-grid/masonary-two-grid.component */ "./src/app/pages/portfolio/masonary-two-grid/masonary-two-grid.component.ts");
/* harmony import */ var _portfolio_masonary_three_grid_masonary_three_grid_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./portfolio/masonary-three-grid/masonary-three-grid.component */ "./src/app/pages/portfolio/masonary-three-grid/masonary-three-grid.component.ts");
/* harmony import */ var _portfolio_masonary_four_grid_masonary_four_grid_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./portfolio/masonary-four-grid/masonary-four-grid.component */ "./src/app/pages/portfolio/masonary-four-grid/masonary-four-grid.component.ts");
/* harmony import */ var _portfolio_masonary_fullwidth_masonary_fullwidth_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./portfolio/masonary-fullwidth/masonary-fullwidth.component */ "./src/app/pages/portfolio/masonary-fullwidth/masonary-fullwidth.component.ts");
/* harmony import */ var _change_password_change_password_component__WEBPACK_IMPORTED_MODULE_30__ = __webpack_require__(/*! ./change-password/change-password.component */ "./src/app/pages/change-password/change-password.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    PagesModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["NgModule"])({
            ...
            declarations: [
                ...
                _save_order_details_save_order_details_component__WEBPACK_IMPORTED_MODULE_6__["SaveOrderDetailsComponent"],
                _error_page_error_page_component__WEBPACK_IMPORTED_MODULE_7__["ErrorPageComponent"],
                _lookbook_lookbook_component__WEBPACK_IMPORTED_MODULE_8__["LookbookComponent"],
                ...
                _collection_collection_component__WEBPACK_IMPORTED_MODULE_14__["CollectionComponent"],
                _forget_password_forget_password_component__WEBPACK_IMPORTED_MODULE_15__["ForgetPasswordComponent"],
                ...
                _faq_faq_component__WEBPACK_IMPORTED_MODULE_21__["FaqComponent"],
                _typography_typography_component__WEBPACK_IMPORTED_MODULE_22__["TypographyComponent"],
                _portfolio_grid_two_col_grid_two_col_component__WEBPACK_IMPORTED_MODULE_23__["GridTwoColComponent"],
                _portfolio_grid_three_col_grid_three_col_component__WEBPACK_IMPORTED_MODULE_24__["GridThreeColComponent"],
                _portfolio_grid_four_col_grid_four_col_component__WEBPACK_IMPORTED_MODULE_25__["GridFourColComponent"],
                _portfolio_masonary_two_grid_masonary_two_grid_component__WEBPACK_IMPORTED_MODULE_26__["MasonaryTwoGridComponent"],
                _portfolio_masonary_three_grid_masonary_three_grid_component__WEBPACK_IMPORTED_MODULE_27__["MasonaryThreeGridComponent"],
                _portfolio_masonary_four_grid_masonary_four_grid_component__WEBPACK_IMPORTED_MODULE_28__["MasonaryFourGridComponent"],
                _portfolio_masonary_fullwidth_masonary_fullwidth_component__WEBPACK_IMPORTED_MODULE_29__["MasonaryFullwidthComponent"],
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvcG9ydGZvbGlvL2dyaWQtZm91ci1jb2wvZ3JpZC1mb3VyLWNvbC5jb21wb25lbnQuc2NzcyJ9 */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvcG9ydGZvbGlvL2dyaWQtdGhyZWUtY29sL2dyaWQtdGhyZWUtY29sLmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvcG9ydGZvbGlvL2dyaWQtdHdvLWNvbC9ncmlkLXR3by1jb2wuY29tcG9uZW50LnNjc3MifQ== */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvcG9ydGZvbGlvL21hc29uYXJ5LWZvdXItZ3JpZC9tYXNvbmFyeS1mb3VyLWdyaWQuY29tcG9uZW50LnNjc3MifQ== */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvcG9ydGZvbGlvL21hc29uYXJ5LWZ1bGx3aWR0aC9tYXNvbmFyeS1mdWxsd2lkdGguY29tcG9uZW50LnNjc3MifQ== */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvcG9ydGZvbGlvL21hc29uYXJ5LXRocmVlLWdyaWQvbWFzb25hcnktdGhyZWUtZ3JpZC5jb21wb25lbnQuc2NzcyJ9 */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvcG9ydGZvbGlvL21hc29uYXJ5LXR3by1ncmlkL21hc29uYXJ5LXR3by1ncmlkLmNvbXBvbmVudC5zY3NzIn0= */"
...
/***/ "./src/app/pages/save-order-details/save-order-details.component.scss":
/*!****************************************************************************!*\
  !*** ./src/app/pages/save-order-details/save-order-details.component.scss ***!
  \****************************************************************************/
/*! no static exports found */
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvc2F2ZS1vcmRlci1kZXRhaWxzL3NhdmUtb3JkZXItZGV0YWlscy5jb21wb25lbnQuc2NzcyJ9 */"

/***/ }),

/***/ "./src/app/pages/save-order-details/save-order-details.component.ts":
/*!**************************************************************************!*\
  !*** ./src/app/pages/save-order-details/save-order-details.component.ts ***!
  \**************************************************************************/
/*! exports provided: SaveOrderDetailsComponent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "SaveOrderDetailsComponent", function() { return SaveOrderDetailsComponent; });
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var SaveOrderDetailsComponent = /** @class */ (function () {
    function SaveOrderDetailsComponent() {
        this.testhtml = JSON.parse(localStorage.getItem("saveorderdata"));
        this.showMsg = false;
        this.showerrMsg = false;
    }
    SaveOrderDetailsComponent.prototype.ngOnInit = function () {
        var saveorderdata = JSON.parse(localStorage.getItem("saveorderdata"));
        console.log(saveorderdata, "saveorderdata");
        if (saveorderdata['response'] == "success") {
            //alert("Successfully!!");
    ...
    SaveOrderDetailsComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'app-save-order-details',
            template: __webpack_require__(/*! raw-loader!./save-order-details.component.html */ "./node_modules/raw-loader/index.js!./src/app/pages/save-order-details/save-order-details.component.html"),
            styles: [__webpack_require__(/*! ./save-order-details.component.scss */ "./src/app/pages/save-order-details/save-order-details.component.scss")]
        }),
        __metadata("design:paramtypes", [])
    ], SaveOrderDetailsComponent);
    return SaveOrderDetailsComponent;
}());
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvc2VhcmNoL3NlYXJjaC5jb21wb25lbnQuc2NzcyJ9 */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvdHlwb2dyYXBoeS90eXBvZ3JhcGh5LmNvbXBvbmVudC5zY3NzIn0= */"
...
module.exports = "\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiJhcHAvcGFnZXMvd2lzaGxpc3Qvd2lzaGxpc3QuY29tcG9uZW50LnNjc3MifQ== */"
...
var base_url = _variables__WEBPACK_IMPORTED_MODULE_3__["url_text"];
var token = _variables__WEBPACK_IMPORTED_MODULE_3__["token_text"];
var startCLogin = _variables__WEBPACK_IMPORTED_MODULE_3__["start_customer_login"];
var cLogin = _variables__WEBPACK_IMPORTED_MODULE_3__["second_customer_login"];
var cLogin = _variables__WEBPACK_IMPORTED_MODULE_3__["second_customer_login"];
var check_account = _variables__WEBPACK_IMPORTED_MODULE_3__["first_api"];
var customerFPassword = _variables__WEBPACK_IMPORTED_MODULE_3__["for_pass"];
var cPasswordOTP = _variables__WEBPACK_IMPORTED_MODULE_3__["changepass_otp"];
var LoginService = /** @class */ (function () {
    function LoginService(httpClient, activeRoute) {
        this.httpClient = httpClient;
        this.activeRoute = activeRoute;
    }
    /******check email******/
    LoginService.prototype.checkEmailFirst = function (email) {
        var _this = this;
        //console.log(this.final_url);
        jquery__WEBPACK_IMPORTED_MODULE_4__(".infinite-scrolling").show();
        var data = { "request": {
                "name": base_url
            },
            "header": {
        ...
        this.httpClient.post(check_account, data).subscribe(function (data) {
            console.log("Workin fine448888");
            if (data["name"] == base_url) {
                console.log("Workin fine44");
                _this.checkifemail(email, data["api_token"]);
            }
            else {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".invalid_request").show();
                //$(".infinite-scrolling").hide();
            }
        });
    };
    /****main fun to call on component request to check email*****/
    LoginService.prototype.startCustomerLogin = function (email, password, account) {
        var _this = this;
        jquery__WEBPACK_IMPORTED_MODULE_4__('.infinite-scrolling').show();
        var data = { "request": {
                "name": base_url
        ...
        this.httpClient.post(check_account, data).subscribe(function (data) {
            if (data["name"] == base_url) {
                _this.startFirstLogin(email, password, data["api_token"], account);
            }
            else {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".invalid_request").show();
            }
    ...
    /******check email exist*******/
    LoginService.prototype.checkifemail = function (email, api) {
        var data = {
            "request": { "username": email },
            "header": { "token": token, "apiToken": api }
        };
        return this.httpClient.post(startCLogin, data).subscribe(function (data) {
            /* console.log('data');
            console.log(data); */
            //$(".infinite-scrolling").show();
            if (data["status"] == "success") {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".second_password").show();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".conemail").hide();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".loginbtn").show();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .email_invalid").hide();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".infinite-scrolling").hide();
                if (data["multiple"] === true) {
                    jquery__WEBPACK_IMPORTED_MODULE_4__(".third_accountid").show();
                }
            }
            else {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .email_invalid").text(data["status"]);
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .email_invalid").show();
                //localStorage.removeItem("user_url");
                //setTimeout(()=>)
    ...
    LoginService.prototype.startFirstLogin = function (email, password, api_token, account) {
        var _this = this;
        var data = {
            "request": { "username": email },
        ...
        return this.httpClient.post(startCLogin, data).subscribe(function (data) {
            if (data["status"] == "success") {
                _this.customerLogin1(email, password, api_token, account);
                console.log("welcome");
                jquery__WEBPACK_IMPORTED_MODULE_4__(".second_password").show();
                jquery__WEBPACK_IMPORTED_MODULE_4__('.infinite-scrolling').hide();
                if (data["multiple"] === true) {
                ...
                jquery__WEBPACK_IMPORTED_MODULE_4__('.infinite-scrolling').hide();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .password_failed").hide();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .email_invalid").show();
            }
        }, function (error) { console.log("Error", error); });
    };
    /******second request to check password email and pass*******/
    LoginService.prototype.customerLogin1 = function (email, password, api_token, account) {
        var data = {
            "request": {
                "username": email,
                "password": password,
        ...
        return this.httpClient.post(cLogin, data).subscribe(function (data) {
            console.log(data);
            if (data["login"] == "success") {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".login_success").show();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .email_invalid").hide();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .password_failed").hide();
            ...
            if (data["login"] == "failed") {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .email_invalid").hide();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .password_failed").text(data["error"]);
                jquery__WEBPACK_IMPORTED_MODULE_4__(".error_msg .password_failed").show();
            }
        }, function (error) { console.log("Error", error); });
    };
    LoginService.prototype.forgetPassword = function (email) {
        ...
        this.httpClient.post(check_account, data).subscribe(function (data) {
            if (data["name"] == base_url) {
                _this.forgotcheckemail(email, data["api_token"]);
            }
            else {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".invalid_request").show();
            }
    ...
    LoginService.prototype.forgotcheckemail = function (email, api) {
        console.log(api);
        var data = { "request": {
                "username": email
            },
        ...
        return this.httpClient.post(customerFPassword, data).subscribe(function (data) {
            if (data["status"] == "success") {
                //window.location.href="/"+this.base_url+"/pages/changepassword?email="+email;
                jquery__WEBPACK_IMPORTED_MODULE_4__(".pass_succ").text(data["status"]);
                jquery__WEBPACK_IMPORTED_MODULE_4__(".email_forgot").hide();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".otp_code").show();
            }
        }, function (error) { console.log("Error", error); });
    };
    /******************get otp code********************/
    LoginService.prototype.enterOTP = function (otp_code, email, new_pass) {
        var _this = this;
        var data = { "request": {
                "name": base_url
            },
        ...
        this.httpClient.post(check_account, data).subscribe(function (data) {
            if (data["name"] == base_url) {
                _this.enterOTPCode(otp_code, email, new_pass, data["api_token"]);
            }
            else {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".invalid_request").show();
            }
    ...
    /****chk otp fun*****/
    LoginService.prototype.enterOTPCode = function (otp_code, email, pass, api_token) {
        console.log(pass);
        var x = otp_code;
        var y = +x; // y: number
        var data = { "request": {
        ...
        return this.httpClient.post(cPasswordOTP, data).subscribe(function (data) {
            console.log(data);
            if (data["status"] == "success") {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".pass_succ span").text(data["status"]);
                jquery__WEBPACK_IMPORTED_MODULE_4__(".pass_succ").show();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".otp_fail").hide();
            }
            else {
                jquery__WEBPACK_IMPORTED_MODULE_4__(".otp_fail").show();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".pass_succ").hide();
                jquery__WEBPACK_IMPORTED_MODULE_4__(".otp_fail span").text(data["error"]);
            }
        }, function (error) { console.log("Error", error); });
    };
    /*****************not used need to remove**************************/
    /***************code for change password*****************/
    LoginService.prototype.getParams = function (url) {
        var params = {};
    ...
    ;
    LoginService.prototype.checkUrl = function () {
        var data = { "request": {
                "name": base_url
            },
            "header": {
